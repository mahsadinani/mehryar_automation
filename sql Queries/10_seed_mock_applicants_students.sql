...
insert into students (id, name, last_name, english_name, national_id, student_id, issuer, father_name, address, phone, emergency_phone, gender, email, status) values
